...
var OBJLoader2Example = (function () {
  ...
  OBJLoader2Example.prototype.initGL = function () {
    ...
    this.resetCamera();
    currentPage === 'kruzof' ? this.camera.position.set(-10, 5, 10) : this.camera.position.set(18, 3, 1), this.camera.rotation.x = 90 * Math.PI / 180
    this.camera.fov = 45
    ...
    function loadSkin(){
      ...
      loader.load("js/orcaswim3.JD",
        function (data) {
          ...
          //skinGroup.scale.set(.045, .045, .045)
